...
interface SeleccionComidasProps {
  peliculaId: string;
  cinemaName: string;
  fecha: string;
  hora: string;
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#000' }}>
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ paddingHorizontal: 28, paddingTop: 48, paddingBottom: 16 }}>
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12 }}>
              <View>
                <Text style={{ fontSize: 12, color: '#8e8e93', marginBottom: 4 }}>Fecha y hora</Text>
        ...
        {/* Lista productos */}
        <ScrollView contentContainerStyle={{ padding: 14, paddingBottom: carrito.length > 0 ? 200 : 40 }}>
          {productos[catActiva].map((p, index) => (
            ...
            >
              ...
              <View style={{ padding: 16 }}>
                <Text style={{ fontSize: tMedio, fontWeight: '700', marginBottom: 6, color: '#fff' }}>
                  {p.name}
                </Text>
                <Text style={{ fontSize: tPeque, color: '#8e8e93', marginBottom: 12, lineHeight: 18 }}>
                  {p.description}
                </Text>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  >
                    <Text style={{ color: 'white', fontSize: tMedio, fontWeight: '600' }}>Agregar</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
            ...
            {carrito.map((item, index) => (
              ...
              >
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <Text style={{ color: '#fff', fontSize: 14, fontWeight: '600', width: 30, textAlign: 'center' }}>
                    {item.cantidad || 1}
                  </Text>
                  <TouchableOpacity
